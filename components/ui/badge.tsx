...
function Badge({ className, variant = 'default', ...props }: BadgeProps) {
  const variants = {
    ...
    secondary: 'bg-[#ECEBFF] dark:bg-[#1A1A1A] text-[#5D5FEF] dark:text-[#EDEDED] border-[#E5E7EB] dark:border-[#222222]',
    destructive: 'bg-[#FF754C] text-white border-transparent',
    outline: 'text-[#1A1D26] dark:text-[#EDEDED] border-[#E5E7EB] dark:border-[#222222]',
